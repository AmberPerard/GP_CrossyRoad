...
private:
	...
	//PART_2 [ADDED]
	struct VertexSoftwarSkinned
	{
		VertexSoftwarSkinned(XMFLOAT3 position, XMFLOAT3 normal, XMFLOAT4 color, float weight0, float weight1) :
	...
	std::vector<VertexSoftwarSkinned> m_SkinnedVertices{};
};
